...
public class ProfilUpdateComplementaireTest extends ProfilUpdateAbstract {

    private static final String NATURE_DEPART = TestData.NATURE_PROFILE_COMPLEMENTAIRE;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "modification nature", "Modification nature", NATURE_DEPART, null);
    }

    @Test(dataProvider = "data")
    public void updateComplementaire(String id, String codenature,
