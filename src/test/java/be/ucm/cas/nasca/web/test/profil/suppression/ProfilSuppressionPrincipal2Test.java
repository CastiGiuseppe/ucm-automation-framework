...
public class ProfilSuppressionPrincipal2Test extends ProfilSuppressionAbstract {

    private static final String NATURE_A_SUPPRIMER = TestData.NATURE_PROFILE_PRINCIPAL;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "supprimer nature", "Supprimer nature", NATURE_A_SUPPRIMER + "2", null);
    }

    @Test(dataProvider = "data")
    public void suppressionPrincipal(String id, String typeEvenement,
