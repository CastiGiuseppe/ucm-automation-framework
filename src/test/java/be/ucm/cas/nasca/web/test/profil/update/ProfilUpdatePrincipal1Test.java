...
public class ProfilUpdatePrincipal1Test extends ProfilUpdateAbstract {

    private static final String NATURE_DEPART = TestData.NATURE_PROFILE_PRINCIPAL;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "modification nature", "Modification nature", NATURE_DEPART + "1", null);
    }
