...
public class EnrolementPP1ETest extends EnrolementPPAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "E", null);
    }
