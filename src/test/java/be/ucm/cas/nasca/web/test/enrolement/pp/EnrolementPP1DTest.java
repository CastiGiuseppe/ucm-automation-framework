...
public class EnrolementPP1DTest extends EnrolementPPAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "D", null);
    }
