...
public class MiseEnDemeurePP1Test extends MiseEnDemeureAbstract {

    private String date = null;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Recouvrement.xlsx", "Mise en demeure", "Mise en demeure", "MED PP1", null);
    }

    @BeforeTest
    public void launchMedPP() {
    ...
    public void doTest(String id, String libelle, String batch, String requete,
        ...
        miseEnDemeurePPFromExcel(batch, requete, solidaire,
                stadeRecouvrement, suspendu, seuilDepasse,
                procedureRecouvrement, procedureRecouvrementFrais, notification, checkRecouvrement,
                date);
