...
public class EnrolementPP1HTest extends EnrolementPPAbstract {
    ...
    public void launchEnrolementPP() {
        doLaunchEnrolement(TRIMESTRE, Calendar.JANUARY);
    }

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "H", null);
    }
