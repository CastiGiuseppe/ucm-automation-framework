...
public class ProfilChangeComplementaireRDA2Test extends ProfilChangeAbstract {

    private static final String NATURE_DEPART = TestData.NATURE_PROFILE_COMPLEMENTAIRE;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "changement nature RDA", "Changement nature RDA", NATURE_DEPART + "2", null);
    }

    @Test(dataProvider = "data")
    public void changeComplementaireRDA(String id, String codenature,
        ...
        changeRDA(codenature, regime, reductiontype, datedebut1, nature2, reductiontype2, datedebut2, controle1,
                cotisation1, cotisation1b, controle2, cotisation2, cotisation2b, NATURE_DEPART);
