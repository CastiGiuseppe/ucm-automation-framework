...
public class ExonerationPM3Test extends ExonerationPMAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Exonération.xlsx", "Exonération PM", "Exonération Personne Morale", "ExonérationPM3", null);
    }
