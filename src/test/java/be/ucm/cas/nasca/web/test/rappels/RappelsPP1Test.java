...
public class RappelsPP1Test extends RappelsAbstract {

    private String date = null;

    private static final String TRIMESTRE = "1";

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Recouvrement.xlsx", "Rappels", "Rappels", "Rappels PP" + TRIMESTRE, null);
    }

    @BeforeTest
    public void launchRappelPP() {
    ...
    public void doTest(String id, String libelle, String batch, String requete, String decede,
        ...
        rappelsPPFromExcel(batch, requete,
                solidaire, suspendu,
                stadeRecouvrement, seuil1Depasse,
                seuil2Depasse,
                procedureRecouvrement, procedureRecouvrement1,
                procedureRecouvrement2, procedureMajoEtCourrier,
                envoiCourrier, envoiRECC, notification, checkRecouvrement, date);
