...
public class EnrolementPP1CTest extends EnrolementPPAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "C", null);
    }
