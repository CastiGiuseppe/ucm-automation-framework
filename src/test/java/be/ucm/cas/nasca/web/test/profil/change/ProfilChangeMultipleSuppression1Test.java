...
public class ProfilChangeMultipleSuppression1Test extends ProfilChangeAbstract {

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "chang multiple - supprimer", "Changement multiple - supprimer", "Profil" + 1, null);
    }
