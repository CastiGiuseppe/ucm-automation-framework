...
public class MiseEnVeilleuse3Test extends MiseEnVeilleuseAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_MiseEnVeilleuse.xlsx", "Mise en veilleuse", "Mise en veilleuse", "MiseEnVeilleuse3", null);
    }
