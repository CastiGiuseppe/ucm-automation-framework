...
public class EnrolementPP1BTest extends EnrolementPPAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "B", null);
    }
