...
public class MiseEnVeilleuse2Test extends MiseEnVeilleuseAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_MiseEnVeilleuse.xlsx", "Mise en veilleuse", "Mise en veilleuse", "MiseEnVeilleuse2", null);
    }
