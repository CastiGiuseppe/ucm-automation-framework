...
public class ProfilChangeComplementaireRDE4Test extends ProfilChangeAbstract {

    private static final String NATURE_DEPART = TestData.NATURE_PROFILE_COMPLEMENTAIRE;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "changement nature RDE", "Changement nature RDE", NATURE_DEPART + "4", null);
    }
