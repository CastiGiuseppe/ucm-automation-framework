...
public class MiseEnDemeurePP3Test extends MiseEnDemeureAbstract {

    private String date = null;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Recouvrement.xlsx", "Mise en demeure", "Mise en demeure", "MED PP3", null);
    }
