...
public class EnrolementPP1ITest extends EnrolementPPAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Enrôlement.xlsx", "Enrôlement PP", "Enrôlement PP", "EnrolPP" + TRIMESTRE + "I", null);
    }
