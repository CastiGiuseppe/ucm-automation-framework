...
public class ExonerationPM2Test extends ExonerationPMAbstract {
    ...
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Exonération.xlsx", "Exonération PM", "Exonération Personne Morale", "ExonérationPM2", null);
    }
