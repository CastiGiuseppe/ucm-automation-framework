...
public class ProfilChangeComplementaireRDA1Test extends ProfilChangeAbstract {

    private static final String NATURE_DEPART = TestData.NATURE_PROFILE_COMPLEMENTAIRE;

    @DataProvider(name = "data")
    public Iterator<Object[]> data() {
        return getDataProvider("TA_Profil.xlsx", "changement nature RDA", "Changement nature RDA", NATURE_DEPART + "1", null);
    }
